...
TREE head[16000] = {NULL};
TREE head1[16000]= {NULL};
int weight[16000] ;
int han_dis[16000];
int finger[16000][130] ;
int finger1[130];
...
int main(int argc, char *argv[])
{
    ...
    file_result = fopen("result10.txt", "w");
    /*for(int i=0;i<20000;i++)
    fprintf(file_result,"%d %s %d\n",i,cnt_article[i].word,cnt_article[i].cnt);*/
    ...
    for (int i = 0; i < num_article; i++)
    {
        ...
        /*for(int j=0;j<N;j++)
        fprintf(file_result,"article%d %s %d\n",i,cnt_article[j].word,weight[j]);*/
