...
LinkList head[100005] = {NULL};
LinkList head1[100005]= {NULL};
int weight[100005] ;
int han_dis[100005];
long long finger[100005][130] ;
long long finger1[130];
char tag_article[100005][12] ;
char tag_sample[12] ;
